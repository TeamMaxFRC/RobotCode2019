...
class Lift {
    ...
    Lift(TalonSRX elevatorMaster, TalonSRX elevatorSlaveOne, TalonSRX elevatorSlaveTwo, TalonSRX elevatorSlaveThree, TalonSRX FourBarTalon, double FourBarOffset) {
        ...
        ArbFFLookup.put(new InterpolatingDouble(0.2), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.21), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.22), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.23), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.24), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.25), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.26), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.27), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.28), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.29), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.3), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.31), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.32), new InterpolatingDouble(0.20));
        ArbFFLookup.put(new InterpolatingDouble(0.33), new InterpolatingDouble(0.15));
        ArbFFLookup.put(new InterpolatingDouble(0.34), new InterpolatingDouble(0.15));
        ArbFFLookup.put(new InterpolatingDouble(0.35), new InterpolatingDouble(0.15));
        ArbFFLookup.put(new InterpolatingDouble(0.36), new InterpolatingDouble(0.15));
        ArbFFLookup.put(new InterpolatingDouble(0.37), new InterpolatingDouble(0.15));
